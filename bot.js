function answerQuery(query) {
  ...
  if (query.indexOf("rain") != -1 || query.indexOf("sun") != -1 || query.indexOf("weather") != -1 || query.indexOf("football") != -1 || query.indexOf("tea") != -1 || query.indexOf("biscuit") != -1)
    return "I do not care too much about tea, biscuits, football or the weather, I'm locked inside a data center.";
